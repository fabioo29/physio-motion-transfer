...
# ---------------------------------------------------------------------------- #
_RENAMED_MODULES = {
    'detectron.utils.collections.AttrDict': 'assets.config.AttrDict',
    'assets.config': 'thirdparty.densepose.assets.config'
}
...
def load_cfg(cfg_to_load):
    ...
    return yaml.load(cfg_to_load, Loader=yaml.Loader) 
