...
trained_model_dir = os.path.join(project_dir,'assets/')
...
parser.add_argument('--configs_yml',type = str,default = 'thirdparty/romp/assets/single_image.yml',help = 'setting for training')
...
model_group.add_argument('--gmodel-path',type = str,default = 'assets/ROMP_hrnet32.pkl',help = 'trained model path of generator')
...
smpl_group.add_argument('--smpl_uvmap',type = str,default = os.path.join(model_dir, 'uv_table.npy'),help = 'smpl UV Map coordinates for each vertice')
smpl_group.add_argument('--smpl_female_texture',type = str,default = os.path.join(model_dir, 'SMPL_sampleTex_f.jpg'),help = 'smpl UV texture for the female')
smpl_group.add_argument('--smpl_male_texture',type = str,default = os.path.join(model_dir, 'SMPL_sampleTex_m.jpg'),help = 'smpl UV texture for the male')
...
hrnet_pretrain = os.path.join(project_dir,'assets/pretrain.pkl')
