...
parser.add_argument('--configs_yml',type = str,default = './video.yml',help = 'setting for training') #'configs/basic_training_v6_ld.yml' 
...
model_group.add_argument('--gmodel-path',type = str,default = '../trained_models/ROMP_hrnet32.pkl',help = 'trained model path of generator')
